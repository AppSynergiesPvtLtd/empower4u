					...
					>
						<div className="relative z-20 text-white lg:ml-auto lg:mr-10 lg:max-w-md ml-auto max-w-[200px] pr-2">
							...
							<p className="text-base font-semibold md:text-lg mb-6">
								Our dedicated team provides tailored therapy for
								individuals with conditions such as Parkinson's
								disease, multiple sclerosis, spinal cord
								injuries, and Guillain-Barre Syndrome.
							</p>
							<a
