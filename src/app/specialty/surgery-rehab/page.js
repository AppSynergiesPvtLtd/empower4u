	...
	items: [
		{
			...
			description:
				"Consolidate your weekly therapy sessions and achieve faster results with our intensive approach.",
		},
		{
			title: "Expert Care at Home",
			description:
				"Receive treatment from highly skilled clinicians in the comfort of your own home.",
		},
		{
		...
		},
		{
			...
			description:
				"Benefit from a tailored rehab program designed using the latest evidence-based practices",
		},
	],
...
const benefitsOfPhysiotherapyData = {
	...
	items: [
		{
			title:
				"Improves strength and endurance pre-surgery, reducing risks.",
			description: "",
		},
		{
			title:
				"Accelerates recovery post-surgery by restoring muscle and cardiovascular function.",
			description: "",
		},
		{
			title:
				...
				<div className="container mx-auto max-w-6xl">
					...
					>
						...
						<p className="text-lg !border-2 !border-primary p-4 mb-8">
							This service is designed to support individuals
							before and after surgery, helping them optimize
							their physical and emotional well-being throughout
							the surgical process. Whether recovering from joint
							replacement procedures, thoracic, abdominal, or
							other major surgeries, prehab focuses on
							strengthening muscles, improving mobility,
							optimising breathing and reducing the risk of
							complications, while rehab ensures a smooth recovery
							by addressing pain management, restoring function,
							and enhancing overall recovery outcomes. These
							services not only improve the physical healing
							process but also reduce the emotional and
							psychological stress that patients often face,
							empowering them to regain their independence and
							quality of life.
						</p>
					</motion.div>
					<motion.div
				...
				{showMore && (
					<>
						<RehabSection
							...
							backgroundColor={
								preAndPostSurgeryData.backgroundColor
							}
						/>
						...
						<RehabSection
							...
							backgroundColor={
								postSurgeryRecoveryData.backgroundColor
							}
						/>
						...
						<RehabSection
							...
							backgroundColor={
								benefitsOfPhysiotherapyData.backgroundColor
							}
						/>
					</>
				)}
