    ...
    <div>
          ...
          >
            <div className="relative z-20 text-white lg:ml-auto lg:mr-10 lg:max-w-md ml-auto max-w-[200px] pr-2">
              ...
              <p className="text-base font-semibold md:text-lg mb-6">
                Easing stiffness, restoring movement, and improving your daily
                life — our unique approach helps you move better and feel
                stronger. With our intensive therapy model, you can accelerate
                your progress and achieve in weeks what traditional methods
                often take months to deliver.
              </p>
              <a
                href={
      ...
      <section className={`bg-[#D5C0A8] py-10`}>
        <div className="max-w-5xl mx-auto p-8">
          ...
          >
            <p className="text-lg mb-6 font-bold text-maintext">
              Common challenges caused by spasticity: 
            </p>
      ...
      <section className="py-16  text-maintext">
        ...
        <div className="mt-8 lg:flex lg:flex-row lg:gap-10 space-y-7 lg:space-y-0 lg:items-center lg:justify-center px-5">
          <div>
            <img
              src="/images/specialty/spasticity-treatment.png"
