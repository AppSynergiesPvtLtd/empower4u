          ...
          >
            <div className="relative z-20 text-white lg:ml-auto lg:mr-10 lg:max-w-md ml-auto max-w-[200px] pr-2">
              ...
              <p className="text-base font-semibold md:text-lg mb-6">
                ...
                rare neurological conditions such as neuromuscular diseases,
                Huntington’s disease, ataxia, ALS, cerebral palsy, and others.
                Our therapists use the latest approaches to deliver specialized
                care that meets your specific needs and goals.
              </p>
              <a
                href={
      ...
      <section className={`bg-[#D5C0A8] py-10`}>
        <div className="max-w-5xl mx-auto p-8">
          ...
          <p className="pb-5 text-maintext font-semibold text-lg">
            Specialized care for complex neurological challenges, here are some
            examples:{" "}
          </p>
          <motion.div
