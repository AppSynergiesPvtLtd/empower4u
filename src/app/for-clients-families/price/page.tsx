    ...
    <section className="py-16 px-4 text-maintext">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-[#d4c0a9] p-8 mb-8">
          <h2 className="text-2xl font-bold mb-8 text-maintext text-center font-inter">Introduction package:</h2>
        ...
        <div className="mb-8 p-8">
          <h2 className="text-2xl font-bold text-maintext mb-8 text-center font-inter">Our Rate:</h2>
          <ul className="list-disc list-inside mt-2 space-y-2 text-lg">
        ...
        <div className="bg-[#d4c0a9] p-8 mb-8">
          <h2 className="text-2xl font-bold mb-8 text-maintext text-center font-inter">Referral benefits:</h2>
          <p className="text-lg">
