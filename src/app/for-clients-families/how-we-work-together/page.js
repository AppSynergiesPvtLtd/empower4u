    ...
    <div>
          ...
          >
            ...
            <div className="relative z-20 text-white lg:ml-auto lg:mr-10 lg:max-w-md ml-auto max-w-[200px] pr-2">
              <h2 className="text-2xl md:text-4xl font-bold mb-4">
                Intensive Home-Based Therapy: Personalized Care for Lasting
                Results
              </h2>
              <p className="text-base font-semibold md:text-lg mb-6">
                Harnessing Technology to Maximize Recovery & Engagement
              </p>
              <a
                href={
      ...
      <section className="py-16 bg-[#f0ebe5] text-maintext">
        <div className="container mx-auto px-4 max-w-5xl flex flex-col items-center justify-center">
          ...
          <img src="/home-work-1.png" className="pb-4 lg:h-[280px] w-auto " />
          <img src="/home-work-2.png" className="pb-4 lg:h-[280px] w-auto " />
          <img src="/home-work-3.png" className="pb-4 lg:h-[280px] w-auto " />
          <img src="/home-work-4.png" className="pb-4 lg:h-[280px] w-auto " />
          <img src="/home-work-5.png" className="pb-4 lg:h-[280px] w-auto " />
        </div>
      </section>
